"""Step 09 — reference-library chemical-space projection, coloured by pathogen activity.
...
ever read at a time, reduced immediately to its top-N rows.
    ...
    python 09_reference_library_projection.py

Outputs
-------
    output/09_reference_library_projection/09_{method}_background.csv
    output/09_reference_library_projection/09_top{PROJECTION_TOP_N}_per_pathogen.csv
    output/09_reference_library_projection/png/09_{method}_top{PROJECTION_TOP_N}_pathogens.png
    output/09_reference_library_projection/pdf/09_{method}_top{PROJECTION_TOP_N}_pathogens.pdf
    output/09_reference_library_projection/figure_cells.json
"""
...
output_dir = os.path.join(root, "..", "output", "09_reference_library_projection")
